...
<script>
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <meta
      property="og:title"
      content="Politique de confidentialité - Allo Taxi Sud Fontvieille" />
    <meta
  ...
  <?php include('./includes/header.php'); ?>
    ...
    <main role="main">
      ...
      <section class="card">
        ...
        <p>
          Le site Allo Taxi Sud Fontvieille a pour objet de fournir une information
          ...
          informations.
          <br /><br />
          Tous les informations indiquées sur le site Allo Taxi Sud Fontvieille sont données
          à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site Allo Taxi Sud Fontvieille ne sont pas
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud Fontvieille est propriétaire des droits de propriété intellectuelle
          ...
          préalable de : Allo Taxi Sud Fontvieille.
          <br /><br />
      ...
      <section class="card">
        ...
        <p>
          Allo Taxi Sud Fontvieille ne pourra être tenu responsable des dommages directs et
          indirects causés au matériel de l’utilisateur, lors de l’accès au site
          Allo Taxi Sud Fontvieille, et résultant soit de l’utilisation d’un matériel ne
          ...
          relatives à la protection des données. Le cas échéant, Allo Taxi Sud Fontvieille
