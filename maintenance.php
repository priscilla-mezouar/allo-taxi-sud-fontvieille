...
<script>
  ...
  <?php include('./includes/head-links.php'); ?>
    ...
    <title>
      Allo Taxi Sud Fontvieille | Taxi 7j/7 à Fontvieille et ses environs
    </title>
    <meta
      name="description"
    ...
    <meta
      ...
      content="Transport de qualité 24h/24 et 7j/7 sur réservation à Fontvieille et ses alentours : Taxis, transferts aéroports, gares, tourisme, évènements, transport médical." />
    ...
    <meta
      ...
      content="Besoin d’un taxi à Fontvieille et ses alentours ? Contactez Allo Taxi Sud Fontvieille : service de transport fiable, ponctuel et confortable." />
